...
/***/ function(module, exports, __webpack_require__) {
	...
	var choreEvents = __webpack_require__(35);
	var groupEvents = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cui = __webpack_require__(12);
	var capi = __webpack_require__(34);
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  }).then(cui.showSuccess).catch(ui.failure);
	};
	...
	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  api.signOut().then(ui.logOutSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(8);
	var successError = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var click = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showNewChore = __webpack_require__(13);
	var showAllChores = __webpack_require__(33);
	...
	var updateCompleteSuccess = function updateCompleteSuccess() {
	  // $('.update-chore').show();
	  // $('.show-chores').hide();
	  // $('.chore-id').hide();
	  // $('.show-chores-button').show(500);
	...
	module.exports = {
	  ...
	  updateCompleteSuccess: updateCompleteSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"chore-container\">\n  <div class=\"row row-centered\">\n    <div class=\"col-xs-4 col-centered box\">\n      <div class=\"content chore-name\">Name: "
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.chore : stack1)) != null ? stack1.name : stack1), depth0))
	    + " </div>\n    </div>\n    <div class=\"col-xs-4 col-centered box\">\n      <div class=\"content chore-due\">Due Date: "
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.chore : stack1)) != null ? stack1.due_date : stack1), depth0))
	    + "</div>\n    </div>\n    <div class=\"col-xs-4 col-centered box\">\n      <div class=\"content chore-difficulty\">Difficulty: "
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.chore : stack1)) != null ? stack1.difficulty : stack1), depth0))
	    + "</div>\n    </div>\n  </div>\n</div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.chores : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"chore-container\">\n  <div class=\"row row-centered\">\n    <div class=\"col-xs-4 col-centered box\">\n      <div class=\"content-"
	    ...
	    + "</div>\n    </div>\n  </div>\n</div>\n<div class=\"button-container\">\n  <div class=\"row row-centered\">\n    <div class=\"col-xs-4 col-centered box\">\n      <button type=\"button\" class=\"center-button update-button btn btn-primary hvr-grow\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update</button>\n    </div>\n    <div class=\"col-xs-4 col-centered box complete-chore\">\n      <button type=\"button\" class=\"complete-chore-button btn btn-success check-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.completed : stack1), depth0))
	    + " hvr-grow\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-completed=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.completed : stack1), depth0))
	    + "\">Complete</button>\n    </div>\n    <div class=\"col-xs-4 col-centered box\">\n     <button type=\"button\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"center-button delete-button btn btn-danger hvr-grow\">Delete</button>\n   </div>\n  </div>\n</div>\n  <div class=\"show-chore\"></div>\n    <br>\n\n<!--  <form class=\"chore-update-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " hidden form-group update-form\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <input type=\"text\" value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + " name=\"chore[name]\">\n    <input type=\"text\" value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.due_date : stack1), depth0))
	    + " name=\"chore[due_date]\" class=\"dpicker\">\n  <input type=\"number\" min=\"1\" max=\"5\" value="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.difficulty : stack1), depth0))
	    + " name=\"chore[difficulty]\" class=\"difficulty\">\n  <button type=\"submit\" class=\"btn btn-primary btn-lg btn-block update-button-2 prevent-default\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update</button>\n  </form>\n</div>\n<hr>-->\n\n\n<div class=\"modal fade show-chore-modal-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n          <h4 class=\"modal-title\" id=\"myModalLabel\">Update Chore</h4>\n      </div>\n      <div class=\"modal-body\">\n          <form class=\"chore-update-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " form-group update-form\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.difficulty : stack1), depth0))
	    + " name=\"chore[difficulty]\" class=\"difficulty\">\n           </div>\n           <button type=\"submit\" class=\"btn btn-primary update-button-2 prevent-default\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update</button>\n           <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Cancel</button>\n          </form>\n          <div class=\"sign-up-fail\"></div>\n      </div>\n    </div>\n  </div>\n</div>\n\n\n\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateChore = function updateChore(id, data) {
	  return $.ajax({
	...
	var completeChore = function completeChore(id, data) {
	  return $.ajax({
	    url: config.host + '/chores/' + id,
	    method: 'PATCH',
	    headers: {
	...
	var showChores = function showChores() {
	  return $.ajax({
	    url: config.host + '/chores',
	    method: 'GET',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateChore = function onCreateChore(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createChore(data).then(function () {
	    ui.createSuccess();
	    return api.showChores();
	  }).then(ui.showSuccess).catch(ui.failure);
	};
	...
	var onUpdateChore = function onUpdateChore(event) {
	  ...
	  api.updateChore(id, data).then(function () {
	    ui.updateSuccess();
	    return api.showChores();
	  }).then(ui.showSuccess).catch(ui.failure);
	};
	...
	var onShowChores = function onShowChores(event) {
	  event.preventDefault();
	  api.showChores().then(ui.showSuccess).catch(ui.failure);
	};

	var onDeleteChore = function onDeleteChore(event) {
	  event.preventDefault();
	  var id = $(this).data().choreId;
	  api.deleteChore(id).then(function () {
	    ui.deleteSuccess();
	    return api.showChores();
	  }).then(ui.showSuccess).catch(ui.failure);
	};

	var onCompleteChore = function onCompleteChore(event) {
	  event.preventDefault();
	  var id = $(this).data().choreId;
	  var data = { chore: { completed: !$(this).data().completed } };
	  api.updateChore(id, data).then(function () {
	    ui.updateSuccess();
	    return api.showChores();
	  }).then(ui.showSuccess).catch(ui.failure);
	...
	var showUpdate = function showUpdate(e) {
	  var className = '.show-chore-modal-' + $(e.target).data().choreId;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateGroup = function onCreateGroup(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createGroup(data).then(ui.success).catch(ui.failure);
	};
