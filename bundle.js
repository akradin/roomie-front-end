...
/***/ function(module, exports, __webpack_require__) {
	...
	var choreEvents = __webpack_require__(10);
	var groupEvents = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(7);
	var successError = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateChore = function onUpdateChore(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.updateChore(data).then(ui.updateSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"chore-container\">\n  <div class=\"row row-centered\">\n    <div class=\"col-xs-4 col-centered box\">\n      <div class=\"content chore-name\">Name: "
	    ...
	    + "</div>\n    </div>\n    <div class=\"col-xs-4 col-centered box\">\n      <div class=\"content chore-difficulty\">ID: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</div>\n    </div>\n  </div>\n  <button type=\"button\" class=\"update-button\">Update</button> <button type=\"button\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
