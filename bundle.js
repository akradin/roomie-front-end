...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateChore = function onCreateChore(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createChore(data).then(ui.createSuccess).catch(ui.failure);
	};
	...
	var onUpdateChore = function onUpdateChore(event) {
	  ...
	  api.updateChore(id, data).then(ui.updateSuccess).catch(ui.failure);
	};
	...
	var onDeleteChore = function onDeleteChore(event) {
	  var id = $(this).data().choreId;
	  event.preventDefault();
	  api.deleteChore(id).then(ui.deleteSuccess).catch(ui.failure);
	};

	var showUpdate = function showUpdate(e) {
	  var className = '.chore-update-' + $(e.target).data().choreId;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showNewChore = __webpack_require__(15);
	var showAllChores = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"chore-container\">\n  <div class=\"row row-centered\">\n    <div class=\"col-xs-4 col-centered box\">\n      <div class=\"content chore-name\">Name: "
	    ...
	    + "</div>\n    </div>\n  </div>\n  <button type=\"button\" class=\"update-button btn btn-primary\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update</button> <button type=\"button\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"delete-button btn btn-success\">Mark as Complete</button>\n  <div class=\"show-chore\">\n    <br>\n\n  <form class=\"chore-update-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " hidden form-group update-form\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <input type=\"text\" placeholder=\"chore\" name=\"chore[name]\">\n    <input type=\"text\" placeholder=\"DD-MM-YYYY\" name=\"chore[due_date]\" class=\"dpicker\">\n  <input type=\"number\" min=\"1\" max=\"5\" placeholder=\"Difficulty, 1-5\" name=\"chore[difficulty]\" class=\"difficulty\">\n  <button type=\"submit\" class=\"btn btn-primary btn-lg btn-block update-button-2 prevent-default\" data-chore-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update</button>\n  </form>\n</div>\n<hr>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
